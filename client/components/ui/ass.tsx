...
// ("Mesh drift"). Zero dependencies: one WebGL
// canvas that fills its parent. Drop it behind your content with
...
const UNIFORMS = {
  // Minimal blue/white/black palette — clean, airy, professional
  colors: [
    [1, 1, 1],
    [0.937, 0.965, 1],
    [0.82, 0.89, 1],
